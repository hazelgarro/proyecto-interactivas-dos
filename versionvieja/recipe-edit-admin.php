...
<body class="banner-background">
    ...
    <section class="d-flex mt-4">
        ...
        <form action="update.php" method="post" enctype="multipart/form-data">
          ...
          //  echo $data[0]["id_recipe_category"];
       
         
          
          echo ' <img id="preview" src="./imagenes/'.$data[0]["recipe_image"].'" width="125" height="125"
                class="img-fluid mt-5" alt="Preview">';?>
            <br>
            <input class="mt-5" id="recipe_image" type="file" name="recipe_image" onchange="readURL(this)">
        ...
        <div class="col ms-4 me-5">
            ...
            <!--recipe title-->
                ...
                <div class="row mt-2">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select form-select-md mb-3" aria-label=".form-select-lg example" name="difficulty"> 
                            ...
                            for ($i = 0; $i < $len; $i++) {
                                if ($data[0]["id_recipe_level"] == $difficulties[$i]['id_recipe_level']) {
                                    echo '<option value="' . $difficulties[$i]['id_recipe_level'] . '" selected>' . $difficulties[$i]['recipe_level'] . '</option>';
                                } else {
                    ...
                    <div class="col">
                        ...
                        <select class="form-select form-select-md mb-3" aria-label=".form-select-lg example"  name="ocassions">
                            ...
                            $len = count($ocassions);
                            for ($i = 0; $i < $len; $i++) {
                                if ($data[0]["id_recipe_category"] == $ocassions[$i]['id_recipe_category']) {
                                    echo '<option value="' . $ocassions[$i]['id_recipe_ocassion'] . '" selected>' . $ocassions[$i]['recipe_ocassion'] . '</option>';
                                } else {
                ...
                <div class="col-4 mt-2">
                    ...
                    <input id="tag" class="form-control" type="text" name="tag" value="<?php echo $data[0]["recipe_tag"]?>">
                </div>
                ...
                <div class="row mt-2">
                    <div class="col">
                        ...
                        <input id="prep-time" class="form-control"  name="prep-time"
                            value="<?php echo $data[0]["recipe_preparation_time"]; ?>">
                    ...
                    <div class="col">
                        ...
                        <input id="prep-time" class="form-control" name="cooking"
                            value="<?php echo $data[0]["recipe_cooking_time"]; ?>">
                    </div>
                    <div class="col">
                        <label class="form-label" for="total-time">Total Time</label>
                        <input id="total-time" class="form-control" name="total-time"
                            value="<?php echo $data[0]["recipe_total_time"]; ?>">
                    </div>
                    <!--recipe portions-->
                    <div class="col">
                        <label class="form-label" for="portions">Portions</label>
                        <input id="portions" class="form-control" type="number" name="portions"  value="<?php echo $data[0]["recipe_yields"]; ?>">
                    </div>
                </div>
                <!--recipe description-->
                <label class="form-label mt-2" for="description">Description </label>
                 ...
                 <?php echo ltrim ( $data[0]["recipe_description"]); ?>
                 </textarea>
                <!--recipe ingredients-->
                <label class="form-label mt-2" for="Ingredientes">Ingredientes </label>
                <div class="" id="ingredients">
                    <?php
                    $ingredients = [];
                    $ingredients = explode(",", $data[0]["recipe_ingredients"]);
                   echo '<textarea  id="ingredientes" class="form-control input-xl" name="ingredientes"  >';
                ...
                <textarea id="preparation" class="form-control input-xl" type="text" name="preparation" ><?php echo $data[0]["recipe_preparation"]; ?></textarea>
        </div>
